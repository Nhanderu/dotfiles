" Darktooth (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/darktooth.".&background.".sh"
  endif
endif
...
call <sid>hi("CursorLineNr",  s:gui03, s:gui01, s:cterm03, "", "")
